...
**For "leather sofas under KES 100,000":**
\`\`\`json
{
  "query": "",
  "category": "sofas",
...
- name, price, priceFormatted (e.g., "KES 59,900.00")
...
**[Product Name](/products/slug)** - KES 59,900.00
- Material: Oak wood
...
- Always include prices in KES (Kenyan Shillings)
